...
state_svg.on("click", function(){
  ...
  var x = d3.scale.ordinal()
             .rangeBands([0, width])
              .domain(plot_Country.map(function(d) { 
  ...
  var ytext = ytextchart.selectAll(".ytext").data(plot_Country).enter().append("div").style("height","25px").append("text").text(function(d) {return countryName(d);});
